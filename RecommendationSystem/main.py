...
features = ['overview', 'keywords', 'genres']
for feature in features:
...
if mood == 'disgust':
    recommendations = get_recommendations('The Grand Budapest Hotel', cosine_sim2)
if mood == 'fear':
    recommendations = get_recommendations('Hugo', cosine_sim2)
if mood == 'happy':
    recommendations = get_recommendations('The Secret Life of Walter Mitty', cosine_sim2)
if mood == 'sad':
